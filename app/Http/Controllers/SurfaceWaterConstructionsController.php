        ...
        foreach($surfaceWaterLocations as $cons){
            array_push($surfaceWaterArray['features'], 
                [
                    ...
                    'type' => 'Feature',
                    'properties' => [
                        'hoverContent' => "<div class='landslide-popup container'><ul class='nav nav-tabs'><li class='active pl-0 pr-2 py-2'> <a data-toggle='tab' href='#thong-tin-sat-lo' class='active show' style='outline: none;'>THÔNG TIN CÔNG TRÌNH</a></li></ul><div class='popup-content tab-content'><div id='thong-tin-sat-lo' class='tab-pane fade in active show'><div class='d-flex align-items-center mt-1'><p class='col-4 p-0 my-1 fw-bold'>Tên công trình:</p><p class='p-0 my-1'>$cons->construction_name</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Công suất:</p><p class='p-0 my-1'><b class='font-15'>$cons->wattage</b> MW</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Q<sub>xả TT</sub></p><p class='p-0 my-1'><b class='font-15'>$cons->q_tt</b> (m<sup>3</sup>/s)</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Q<sub>KT max</sub></p><p class='p-0 my-1'><b class='font-15'>$cons->q_kt_max</b> (m<sup>3</sup>/s)</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Q<sub>KT max MK</sub></p><p class='p-0 my-1'><b class='font-15'>$cons->q_kt_max_mk</b> (m<sup>3</sup>/s)</p></div></div><div id='hinh-anh' class='tab-pane fade'> <img class='w-100 d-block' style='height:200px;' alt='hinh-anh-sat-lo' src='https://kc08.s3-ap-southeast-1.amazonaws.com/landslide-locations/2020/96.JPG'></div></div></div>",
                    ],
                    'id' => $cons->gid
                ]);
        }
    ...
    public function surfacewaterConstructionInfo($id)
    {
        ...
        array_push($surfaceWaterArray['features'], 
            [
                ...
                'type' => 'Feature',
                'properties' => [
                    'hoverContent' => "<div class='landslide-popup container'><ul class='nav nav-tabs'><li class='active pl-0 pr-2 py-2'> <a data-toggle='tab' href='#thong-tin-sat-lo' class='active show' style='outline: none;'>THÔNG TIN CÔNG TRÌNH</a></li></ul><div class='popup-content tab-content'><div id='thong-tin-sat-lo' class='tab-pane fade in active show'><div class='d-flex align-items-center mt-1'><p class='col-4 p-0 my-1 fw-bold'>Tên công trình:</p><p class='p-0 my-1'>$construction->construction_name</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Công suất:</p><p class='p-0 my-1'><b class='font-15'>$construction->wattage</b> MW</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Q<sub>xả TT</sub></p><p class='p-0 my-1'><b class='font-15'>$construction->q_tt</b> (m<sup>3</sup>/s)</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Q<sub>KT max</sub></p><p class='p-0 my-1'><b class='font-15'>$construction->q_kt_max</b> (m<sup>3</sup>/s)</p></div><div class='d-flex align-items-center'><p class='col-4 p-0 my-1 fw-bold'>Q<sub>KT max MK</sub></p><p class='p-0 my-1'><b class='font-15'>$construction->q_kt_max_mk</b> (m<sup>3</sup>/s)</p></div></div><div id='hinh-anh' class='tab-pane fade'> <img class='w-100 d-block' style='height:200px;' alt='hinh-anh-sat-lo' src='https://kc08.s3-ap-southeast-1.amazonaws.com/landslide-locations/2020/96.JPG'></div></div></div>",
                ],
                'id' => $construction->id
            ]);
