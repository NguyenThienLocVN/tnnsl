...
<header>
    ...
    <div class="bg-primary d-flex flex-column flex-lg-row top-bar">
        <div class="col-lg-5 col-sm-12 col-md-12 px-0 pt-md-0 pb-md-0 d-flex align-items-center">
            ...
            <a href="{{route('gioi-thieu-chung')}}" class="font-weight-bold text-white d-block pl-2"><i class="fa fa-home" aria-hidden="true"></i>&nbsp; GIỚI THIỆU CHUNG</a>
        </div>
...
<main class="d-flex flex-column flex-lg-row">
    <div class="col-12 col-lg-5 pb-3 pb-lg-0 px-lg-0">
        <div class="d-flex align-items-center pt-3">
            <img class="introduce-image" src="{{asset('public/TNN_TRANG_CHU/image/ANH_HETHONGGIAMSAT.png')}}" alt="ANH_HETHONGGIAMSAT">
            <b class="pl-2 introduct-text">GIỚI THIỆU HỆ THỐNG QUẢN LÝ GIÁM SÁT</b>
        </div>
        <div class="d-flex align-items-center pt-3">
            <img class="introduce-image" src="{{asset('public/TNN_TRANG_CHU/image/ANH_QUANLYCAPPHEP.png')}}" alt="ANH_QUANLYCAPPHEP">
            <b class="pl-2 introduct-text">GIỚI THIỆU HỆ THỐNG QUẢN LÝ CẤP PHÉP</b>
        </div>
        <div class="d-flex align-items-center pt-3">
            <img class="introduce-image" src="{{asset('public/TNN_TRANG_CHU/image/ANH_QUANLYDULIEU.png')}}" alt="ANH_QUANLYDULIEU">
            <b class="pl-2 introduct-text">GIỚI THIỆU HỆ THỐNG QUẢN LÝ DỮ LIỆU</b>
        </div>
        <div class="d-flex align-items-center pt-3">
            <img class="introduce-image" src="{{asset('public/TNN_TRANG_CHU/image/ANH_BIEUMAUBAOCAO.png')}}" alt="ANH_BIEUMAUBAOCAO">
            <b class="pl-2 introduct-text">GIỚI THIỆU HỆ THỐNG QUẢN LÝ BÁO CÁO</b>
        </div>
        <div class="d-flex align-items-center pt-3">
            <img class="introduce-image" src="{{asset('public/TNN_TRANG_CHU/image/ANH_THONGBAO.png')}}" alt="ANH_THONGBAO">
            <b class="pl-2 introduct-text">GIỚI THIỆU HỆ THỐNG QUẢN LÝ THÔNG BÁO</b>
        </div>
        <div class="d-flex align-items-center pt-3">
            <img class="introduce-image" src="{{asset('public/TNN_TRANG_CHU/image/ANH_HUONGDANQUYDINH.png')}}" alt="ANH_HUONGDANQUYDINH">
