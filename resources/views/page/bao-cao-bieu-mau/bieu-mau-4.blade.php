...
<body class=" p-0" data-new-gr-c-s-check-loaded="14.998.0" data-gr-ext-installed="" cz-shortcut-listen="true">
    ...
    <main class="px-3">
        <div class="text-primary row m-0 align-items-center py-2">
            <div class="h4">Biểu mẫu số 4: Tổng lượng nước mặt trên các lưu vực sông </div>
        </div>
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th colspan=4>Tổng lượng dòng chảy năm(triệu m3)</th>
                    <th colspan=4>Tổng lượng dòng chảy mùa lũ (triệu m3)</th>
                    <th colspan=4>Tổng lượng dòng chảy mùa cạn (triệu m3)</th>
                </tr>
                <tr>
                    <td>Trung bình nhiều năm</td>
                    <td>Kỳ trước</td>
                    <td>Kỳ báo cáo</td>
                    <td>Thay đổi</td>
                    <td>Trung bình nhiều năm</td>
