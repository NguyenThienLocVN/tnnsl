    ...
    <header class="container p-0">
        ...
        <div class="bg-primary d-flex flex-column flex-lg-row top-bar">
            <div class="col-lg-12 col-sm-12 col-md-12 px-0 pt-md-0 pb-md-0 d-flex align-items-center">
                ...
                <span class="font-weight-bold text-white d-block pl-2">BIỂU MẪU BÁO CÁO - MẪU 3</span>
            </div>
        </div> 
    </header>
    <main class="px-3">
        <div class="text-primary row m-0 align-items-center py-2">
            <div class="h4">Biểu mẫu số 3: Lượng mưa tháng, năm trong kỳ báo cáo </div>
        </div>
        <table class="table table-bordered">
            <thead>
                <tr class="align-middle text-center text-nowrap">
                    ...
                    <th colspan="12">Lượng mưa tháng (mm)</th>
                    <th>Lượng mưa năm (mm)</th>
                </tr>
                <tr class="align-middle text-center text-nowrap">
                    <td>I</td>
                    <td>II</td>
