                ...
                <table class="table-license-manage table" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('quan-ly-cap-phep-nuoc-mat', $cons->id)}}" class="construction-link text-primary"><img src="{{asset('public/TNN_QUAN_LY_CAP_PHEP/image/earth.png')}}" class="earth-icon" alt="earth" />&nbsp;{{$cons->construction_name}}</a></td>
