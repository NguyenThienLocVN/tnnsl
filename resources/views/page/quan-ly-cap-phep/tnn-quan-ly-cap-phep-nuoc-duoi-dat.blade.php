...
<header>
    ...
    <div class="bg-primary d-flex flex-column flex-lg-row top-bar">
        <div class="col-lg-5 col-sm-12 col-md-12 px-0 pt-md-0 pb-md-0 d-flex align-items-center">
            ...
            <span class="fw-bold text-white d-block pl-2 exploit-surfacewater-heading">QUẢN LÝ CẤP PHÉP / KHAI THÁC SD NƯỚC DƯỚI ĐẤT</span>
        </div>
...
<main class="d-flex flex-column flex-lg-row">
    <div class="col-12 col-lg-5 pb-3 pb-lg-0 px-md-0" id="surfacewater-usage">
        ...
        <div class="surfacewater-usage mb-2">
          	<p class="col-12 py-1 surfacewater-usage-title fw-bold mb-2">Quan trắc tài nguyên nước dưới đất</p>
        ...
        <div class="col-12 d-flex flex-column flex-md-row mb-1 p-0 surfacewater-usage">
            <div class="col-md-12 col-12 d-flex pl-0 pr-0 mb-md-0 align-items-center">
                <span class="col-12 py-2 fw-bold">Thông tin kỹ thuật công trình &nbsp; <a href="{{route('nuoc-duoi-dat-ky-thuat-cong-trinh')}}" class="col-2 px-2 py-1 btn btn-license border-0 font-13 mr-2 rounded text-center">Xem</a> </span>
            </div>
        </div>
