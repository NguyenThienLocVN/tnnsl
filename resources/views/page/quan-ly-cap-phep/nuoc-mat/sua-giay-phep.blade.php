...
<main class="d-flex flex-column flex-lg-row">
    <div class="col-12 col-lg-5 pb-3 pb-lg-0 px-md-0" id="surfacewater-usage">
        ...
        <div class="exploit-surfacewater mb-2">
            <p class="col-12 py-1 exploit-surfacewater-title fw-bold mb-2">Sửa giấy phép KT nước mặt</p>
            @if ($errors->any())
            ...
            {{ csrf_field() }}
                <div class="exploit-surfacewater-content col-12 p-0 mb-3">
                    ...
                    <div class="col-12 d-flex my-3">
                        <button type="submit" class="col-3 px-2 py-2 fw-bold btn-success border-0 font-13 mr-2 rounded">Lưu</ type="submit">
                        <button type="reset" class="col-3 px-2 py-2 fw-bold btn-danger border-0 font-13 mr-2 rounded">Nhập lại</button>
                    </div>
                </div>
            </form>
        </div>
