...
<header>
    ...
    <div class="bg-primary d-flex flex-column flex-lg-row top-bar">
        <div class="col-lg-5 col-sm-12 col-md-12 px-0 pt-md-0 pb-md-0 d-flex align-items-center">
            ...
            <span class="fw-bold text-white d-block pl-2">ĐỀ NGHỊ CẤP LẠI PHÉP XẢ THẢI VÀO NGUỒN NƯỚC</span>
        </div>
...
<main class="d-flex flex-column flex-lg-row">
    ...
    <div class="exploit-surfacewater mb-2">
        ...
        <div class="the-reason-for-the-re_issuance-of-the-license exploit-surfacewater mb-2">
            <p class="col-12 py-1 information-about-license-owner-title fw-bold mb-2">2. LÝ DO ĐỀ NGHỊ CẤP LẠI GIẤY PHÉP</p>
        ...
        <div class="records-and-documents-attached exploit-surfacewater mb-2">
            <p class="col-12 py-1 information-about-license-owner-title fw-bold mb-2">3. GIẤY TỜ TÀI LIỆU NỘP KÈM THEO</p>
        ...
        <div class="exploit-surfacewater mb-2">
            <p class="col-12 py-1 information-about-license-owner-title fw-bold mb-2">4. CAM KẾT CỦA CHỦ GIẤY PHÉP</p>
            <div class="exploit-surfacewater-content col-12 p-0 mb-3">
