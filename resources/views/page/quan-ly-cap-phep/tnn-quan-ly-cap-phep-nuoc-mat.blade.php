    ...
    <div class="exploit-surfacewater-content col-12 p-0 mb-3">
        ...
        <div class="col-12 d-flex flex-column flex-md-row my-1">
            ...
            <div class="col-sm-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                ...
                <input type="text" id="license_role" class="col-7 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1">
            <div class="col-sm-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Đơn vị XCP</span>
                <input type="text" id="organization_request" class="col-7 px-1 font-13">
            </div>
            <div class="col-sm-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Cơ quan CP</span>
                <input type="text" id="organization_authorities" class="col-7 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-2">
            <div class="col-sm-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Năm XD</span>
                <input type="text" id="year_built" class="col-md-4 col-2 px-1 font-13">
            </div>
            <div class="col-sm-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Năm VH</span>
                <input type="text" id="year_operation" class="col-md-4 col-2 px-1 font-13">
            </div>
        </div>
    ...
    <div class="construction-info-content col-12 p-0 mb-3">
        <div class="col-12 d-flex flex-column flex-md-row mb-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                ...
                <input type="text" id="construction_name" class="col-7 px-1 font-13">
            </div>
            <div class="col-md-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Ký hiệu CT</span>
                <input type="text" id="construction_code" class="col-md-7 col-3 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1 my-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Mục đích SDN</span>
                <input type="text" id="purpose_using_water" class="col-7 px-1 font-13">
            </div>
            <div class="col-md-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Nguồn nước</span>
                <input type="text" id="water_source" class="col-7 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1 mb-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Huyện</span>
                <input type="text" id="district" class="col-7 px-1 font-13">
            </div>
            <div class="col-md-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Xã</span>
                <input type="text" id="commune" class="col-7 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1 mb-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Vị trí đập &nbsp; X </span>
                <input type="text" id="long_dams" class="col-7 px-1 font-13">
            </div>
            <div class="col-md-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Vị trí NM &nbsp; X</span>
                <input type="text" id="long_factory" class="col-7 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1 mb-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Vị trí đập &nbsp; Y</span>
                <input type="text" id="lat_dams" class="col-7 px-1 font-13">
            </div>
            <div class="col-md-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Vị trí NM &nbsp; Y</span>
                <input type="text" id="lat_factory" class="col-7 px-1 font-13">
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1 mb-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-5 font-13 px-0">Chế độ KT</span>
                <input type="text" id="exploit_mode" class="col-7 px-1 font-13">
            </div>
            <div class="col-md-6 col-12 d-flex pr-0 pl-0 pl-md-3 align-items-center">
                <span class="col-5 font-13 px-0">Công suất</span>
                <input type="text" id="wattage" class="col-3 px-1 font-13"> &nbsp; <span class="font-13">(MW)</span>
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1 mb-1">
            <div class="col-md-6 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
        ...
        <div class="col-12 d-flex flex-column flex-md-row mb-1">
            <div class="col-md-12 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-12 font-13 px-0">DT tưới/tiêu tk : <input type="text" id="watering_area" class="col-3 px-1"> (ha) &nbsp; </span>
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1">
            <div class="col-md-12 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-12 font-13 px-0">Q<sub>tưới/tiêu</sub> tk : <input type="text" id="q_tuoi_tieu" class="col-3 px-1"> (m<sup>3</sup>/s) &nbsp; </span>
            </div>
        </div>
        <div class="col-12 d-flex flex-column flex-md-row mb-1">
            <div class="col-md-12 col-12 d-flex pl-0 pr-0 pr-md-3 mb-1 mb-md-0 align-items-center">
                <span class="col-12 font-13 px-0">Q<sub>cấp nước</sub> SH, SX : <input type="text" id="q_cap_nuoc" class="col-3 px-1"> (m<sup>3</sup>/ngđ) &nbsp; </span>
            </div>
        </div>
    </div>
</div>
